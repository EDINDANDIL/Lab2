...
Так же будем пользоваться массивами. Сама матрица представляет собой двумерный массив(массив массивов). Для хранения количества вхождений и гласных/согласных букв
будем пользоваться массивами.
...
1. **Ввод данных:**  
   Программа считывает три целых числа, обозначенные как `N`,`M` и `K`.
