...
1. **Сравнение элементов массива:**  
   Написан метод `sortArr`, который сортирует элменты массива в лексикографическом порядке. Берется элемент массива и сравнивается с каждым элементом, если выбранный элемень меньше встретившегося, то они меняются местами.
...
1. Тестируем, работает ли программа на матрице 3x3, строчных буквах буквах:
    ...
    - **Output**:
      ...
      Согласные буквы:[c, k, l, m, t, x]
      Гласные буквы:[a, i, o]
      Количество букв: a = 1; c = 1; i = 1; k = 1; l = 1; m = 1; o = 1; t = 1; x = 1; 
      Самая частая(ые) буква(ы): a c i k l m o t x 
        ```

2. Тест на матрицу 3x4, заглавных буквах, сдвигом 4:
